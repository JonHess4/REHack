...
<!-- This <TR> is where the action interface is held -->
	...
	<!-- Action 6: Exchange a Consumed polyp tile for a larva cube -->
                                                                            ...
                                                                            <TD WIDTH=50%>
																				...
																				?>
                                                                                </B> Exchange a consumed polyp tile for a larva cube of the same colour (larva cube must be played immediately)</TD>
                                                                        </TR>
                                                                        <TR>
	...
	<!-- Action 7: Play a cylinder -->
                                                                            ...
                                                                            <TD WIDTH=50%>
																				...
																				?>
                                                                                </B> Acquire and play an alga cylinder</TD>
                                                                        </TR>
                                                                        <TR>
